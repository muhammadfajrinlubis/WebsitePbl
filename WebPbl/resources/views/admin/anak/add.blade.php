            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" value="{{ old('tgl_lahir') }}" name="tgl_lahir" id="tgl_lahir" required placeholder="Tanggal Lahir">
                    </div>
                    <div class="form-group">
                      <label>Alamat</label>
              ...
              <script>
                document.querySelector('form').addEventListener('submit', function(event) {
                    var tglLahir = new Date(document.querySelector('input[name="tgl_lahir"]').value);
                    var now = new Date();
                    var ageInMonths = (now.getFullYear() - tglLahir.getFullYear()) * 12 + (now.getMonth() - tglLahir.getMonth());

                    if (ageInMonths > 60) {
                        alert('Umur anak melebihi 60 bulan.');
